		...
		if(isset($_POST['submit']))
		{
			...
			if(mysqli_num_rows($result1) > 0)
			{
				echo "<script>
						...
						window.location=\"admin_add_leave.php\";
					  </script>";
			}
			else
			{
				...
				foreach($result3 as $row3)
				{
					...
					$staff_firstName = $row3['FIRST_NAME'];
					$staff_lastName = $row3['LAST_NAME'];
					$sql4 = "INSERT INTO leave_statistics (STAFF_ID, LEAVE_TYPE, MAX_LEAVE) VALUES( '$staff_id', '$leave_type', '$number_of_days')";
					...
					<table>
						<thead>
							<tr>
								<th>Enter Leave:</th>
								<th>
									<input type="text" name="typeOfLeave" placeholder="Leave" required>
								</th>
							</tr>
							<tr>
								<th>Enter Number Of Days:</th>
								<th>
									<input type="text" name="numberOfDays" placeholder="Days" required>
								</th>
							</tr>
							<tr>
								<th>
...
function add()
{
	var msg = confirm("Add This Leave ?");
	if(msg == true)
		return true;
	else
		return false;
