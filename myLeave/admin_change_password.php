<?php
	...
	if($_SESSION['sid'] == session_id() && $_SESSION['user_type'] == "Admin")
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1 = "SELECT * FROM login WHERE USER_ID = '$admin_id'";
			...
			if(mysqli_num_rows($result1) > 0)
			{
				...
				{
					$dbPass = $row1['USER_PASS'];
				}
				
				if(strcmp($dbPass, $oldPass) != 0)
				{
						echo '<script language="javascript">';
						echo 'alert("Wrong Password ! Please Try Again"); location.href="admin_change_password.php"';
						echo '</script>';
				}
				else
				{
					...
					{
						echo '<script language="javascript">';
						echo 'alert("New Password Is Same To Old Password !\nPlease Try Again !"); location.href="admin_change_password.php"';
						echo '</script>';
					}
					else
					{
						$sql2 = "UPDATE login SET USER_PASS = '$newPass' WHERE USER_ID = '$admin_id'";
						$result2 = mysqli_query($conn, $sql2);
						$sql3 = "UPDATE admin SET ADMIN_PASS = '$newPass' WHERE ADMIN_ID = '$admin_id'";
						$result3 = mysqli_query($conn, $sql3);

						echo '<script language="javascript">';
						echo 'alert("Password Has Been Changed !"); location.href="admin_homepage.php"';
						echo '</script>';
					}
				}
			}
