					...
					<tbody>
						<?php
							foreach($result as $row)
							{
								...
								echo "<td> <a href='admin_delete_leave_db.php?leave_type=".$leave_type."'\><button class=\"backBtn\" onClick=\"return remove()\">Delete</button></a></td>";
								echo "<td> <a href='admin_update_leave.php?leave_type=".$leave_type."'\><button class=\"backBtn\">Update</button></a></td>";
								echo "</tr>";
							}
						?>
						<tr>
							<td>
								<a href="admin_homepage.php"><button class="backBtn" style="margin-bottom: 5px;">Back</button></a>
							</td>
							<td></td>
							<td></td>
						</tr>
...
function remove()
{
	var msg = confirm("Delete This Leave ?");
	if(msg == true)
		return true;
	else
		return false;
