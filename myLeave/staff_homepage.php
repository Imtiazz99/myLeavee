<?php
	...
	{	
		...
		$sql1 = "SELECT * FROM leave_statistics WHERE STAFF_ID = '$staff_id'";
					...
					<tbody>
						<?php
							foreach($result1 as $row1)
							{
								...
								$maximum_leaves = $row1['MAX_LEAVE'];
								$leaves_taken = $row1['LEAVE_TAKEN'];
								echo "<tr>";
								echo "<td>$leave_type</td>";
								echo "<td>$maximum_leaves</td>";
								echo "<td>$leaves_taken</td>";
								$remaining_leaves = $maximum_leaves - $leaves_taken;
								if($remaining_leaves > 0)
								{
									echo "<td>$remaining_leaves</td>";
								}
								else
								{
									$remaining_leaves = 0;
