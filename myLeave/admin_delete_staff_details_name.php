<?php
	...
	{	
		...
		$sql = "SELECT * FROM staff WHERE FIRST_NAME LIKE '%$staff_name%' OR LAST_NAME LIKE '%$staff_name%'";
  ...
  <main class="main">
    ...
    <div class="card">
		...
		<div class="card__main">
			<div class="card__row">
				<form action="admin_delete_staff_details_db.php" method="post">
					<table>
						<thead>
							<tr>
								<th>Staff ID:</th>
							...
							<tr>
								<th>taff Password:</th> 
								<th>
									<input type="text" name="password" id="password" value="<?php echo $staff_pass ?>" readonly>
								</th>
							</tr>
							<tr>
								<th>
									<input type="submit" name="submit" value="Delete" onClick="return remove()">
								</th>
								<th>
									<a href="admin_delete_staff.php">Back</a>
								</th>
							</tr>
						</thead>
					</table>
...
function remove() 
{
	var msg = confirm("Delete This Account ?");
	if(msg == true)
		return true;
	else
		return false;
