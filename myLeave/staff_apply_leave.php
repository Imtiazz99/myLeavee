  ...
  <main class="main">
    ...
    <div class="card">
		...
		<div class="card__main">
			<div class="card__row">
				<form action="staff_apply_leave_db.php" method="post">
					<table>
						<tbody>
							<tr>
							</tr>
							...
							<tr>
								<td>Start Date :</td>
								<td>        									
									<input type="date" name="start_date" id="start_date" onchange="total_days()" min="2019-12-09" required/>
								</td>
							</tr>
							<tr>
								<td>End Date :</td>
								<td>        									
									<input type="date" name="end_date" id="end_date" onchange="total_days()" min="2019-12-09" required/>
								</td>
							</tr>
							<tr>
								<td>Total Days</td>
								<td>											
									<input type="text" name="days_requested" id="days_requested" readonly="true"/>
								</td>
							</tr>
							<tr>
								<td>          									
									<input type="submit" value=Apply onClick="return apply()" id="submit"/>
								</td>
								<td></td>
							</tr>
						</tbody>
