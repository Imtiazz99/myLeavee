    ...
    <div class="main-header">
      <div class="main-header__intro-wrapper">
        <div class="main-header__welcome">
          <div class="main-header__welcome-title"><em></em>Welcome, <strong><i><?php echo $admin_firstName ?></i></strong></div>
					...
					<table>
						<thead>
							<tr>
								<th>Staff ID:</th>
								<th>
									<input type="text" value=" <?php echo $staff_id; $_SESSION['staff_id'] = $staff_id; ?>" readonly>
								</th>
							</tr>
							<tr>
								<th>Staff Department:</th>
								<th>
									<input type="text" name="department" value="<?php echo $staff_dept ?>" required>
								</th>
							</tr>
							<tr>
								<th>Staff First Name:</th>
								<th>
									<input type="text" name="firstName" value="<?php echo $staff_firstName ?>" required>
								</th>
							</tr>
							<tr>
								<th>Staff Last Name:</th>
								<th>
									<input type="text" name="lastName" value="<?php echo $staff_lastName ?>" required>
								</th>
							</tr>
							<tr>
								<th>Staff Password:</th>
								<th>
									<input type="text" class="btn btn-outline-secondary"  name="password" id="password" value="<?php echo $staff_pass ?>" required="required" />
								</th>
							</tr>
							<tr>
								<th>
								...
								<th>
									<a href="admin_update_staff.php">Back</a>
								</th>
							</tr>
						</thead>
					</table>
...
function update() 
{
	var msg = confirm("Update This Account ?");
	if(msg == true)
		return true;
	else
		return false;
