<?php
	...
	{	
		...
		$sql = "SELECT * FROM leave_requests WHERE STAFF_ID = '$staff_id' AND LEAVE_STATUS = 'Approved' OR  LEAVE_STATUS = 'Rejected'";
		$result = mysqli_query($conn, $sql) or die (mysqli_error());
		
		if(mysqli_num_rows($result) == 0)
		{
			echo "<script>
					alert(\"Leave History Not Available !\");
