<?php
	...
	{	
		...
		if($no_of_rows == 0)
		{
			echo "<script>alert(\"No Leave Request To Show !\");
		...
		<div class="card__main">
			<div class="card__row">
				<table>
					<thead>
						<tr>
							<th colspan="2">Total Requests Received : <?php echo $no_of_rows; ?></th>
							<th></th>
							<th></th>
							<th></th>
							<th></th>
					...
					<tbody>
						<?php
							foreach($result as $row)
							{
								...
								echo "<tr>";
								echo "<td><a href='admin_view_request_staff_profile.php?staff_id=".$staff_id."'\>$staff_id</a></td>";
								echo "<td>$leave_type</td>";
								echo "<td>$start_date</td>";
								echo "<td>$days_requested</td>";
								echo "<td>$date_applied</td>";
								echo "<td><a href='admin_view_request_approve_reject.php?staff_id=".$staff_id."&start_date=".$start_date."'\>Details</a></td>";
							}	
						?>
					</tbody>
				</table>
