  ...
  <main class="main">
    ...
    <div class="card">
		...
		<div class="card__main">
			<div class="card__row">
				<form action="admin_update_leave_db.php" method="post">
					<table>
						<thead>
              ...
              ?>
							<tr>
								<th>LEAVE_TYPE:</th>
								<th>
										<input type="text" name="leave_type" value="<?php echo $leave_type ?>" required>
								</th>
							</tr>
							<tr>
								<th>NO_OF_DAYS:</th>
								<th>
									<input type="text" name="noofdays" value="<?php echo $no_of_days ?>" required>
								</th>
							...
							<tr>
								...
								<th>
									<a href="admin_delete_leave.php">Back</a>
								</th>
							</tr>
						</thead>
					</table>
...
function update()
{
	var msg = confirm("Update This Leave ?");
	if(msg == true)
		return true;
	else
		return false;
